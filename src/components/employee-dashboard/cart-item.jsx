...
export function CartItemComponent({ item, onUpdateQuantity, onRemoveItem }) {
  ...
  return (
    <div className="flex items-center gap-3 p-3 border rounded-lg">
      <div className="hidden sm:blockw-12 h-12 relative bg-gray-100 rounded overflow-hidden flex-shrink-0">
